---
title: "@pro/core IoC Container and globalThis.core API"
...
<Note>
  `init()` is called automatically at module load time via the `import './core/provide'` side effect in `packages/core/src/lib/index.ts`. You do not need to call it manually.
</Note>
