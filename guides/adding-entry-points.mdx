---
title: "Adding a New Runtime Mode to @pro/main"
sidebarTitle: "New Entry Points"
description: "Create a custom execution mode in @pro/main by adding a CLI flag, a new mode file, and re-exporting it — all following the pattern of backtest.ts and live.ts."
---
