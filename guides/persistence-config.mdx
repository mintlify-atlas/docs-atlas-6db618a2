---
title: "Per-Subsystem Persistence Adapter Configuration Guide"
sidebarTitle: "Persistence"
description: "Configure storage adapters per backtest-kit subsystem in setup.config.ts — swap between MongoDB, local file, and in-memory backends per run mode."
---
